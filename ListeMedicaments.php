...
if (isset($_GET["search"])) {
    ...
    $requette = "select * from medicaments  where designation like '%$designation%'and laboratoire like '%$laboratoire%' order by designation limit $offset,$limit";
} else {
    $requette = "select * from medicaments order by designation limit $offset,$limit";
}
...
<head>
    ...
    <title>Listes des patients de l'hopital</title>
...
<body>
    <form action="" method="get" style="text-align: center;">
        <div>
            <label for="">Nom du medicaments</label>
            <input type="text" name="designation" id=""><br><br>
            <label for="">Laboratoire du medicaments </label>
            <input type="text" name="laboratoire" id=""><br><br>
            <button type="submit" name="search">Rechercher</button>
        </div>
    </form>
    <h1>Listes des médicaments de l'hopital <br> <a href="AjoutMedecin.php">Ajouter un nouveau Médécin</a> <br> <a href='deconnexion.php'>Déconnectez-vous</a><br><a href='ListConnexion.php'>ListConnexion.php</a><br><a href='ListeMedecin.php'>ListeMedecins.php</a><br><a href='testcompatibilite.php'>testcompatibilité.php</a></h1>
    <table>
        <tr>
            <th>#</th>
            <th>Designation</th>
        ...
        while ($ligne = mysqli_fetch_assoc($execute)) {
            ...
            $refmed = $ligne["refmed"];
            echo " <tr><td>$ligne[refmed]</td><td>$ligne[designation]</td><td>$ligne[laboratoire]</td><td>$ligne[prix]</td><td><a href='modifier.php?identifiant= $refmed'><img src='modif.png' alt='modifier' width='15px'></a></td><td><a href='supprimer.php?identifiant= $refmed'><img src='sup.png' alt='Supprimer' width='15px'></a></td></tr>";
        }
        ?>
